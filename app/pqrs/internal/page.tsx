...
const initialPqrsItems = {
  pendientes: [
    {
      id: '1',
      title: 'Solicitud de acceso a recursos',
      description: 'Necesito acceso a los recursos del curso de matemáticas',
    ...
    },
    {
      ...
      description: 'No puedo acceder a los materiales del curso',
      department: 'Sistemas',
      date: '2024-03-14',
      priority: 'Media'
    }
...
export default function InternalPQRSPage() {
      ...
      <div className="flex-1 ml-72">
        ...
        <div className="h-16 border-b border-olive-dark/10 flex items-center justify-between px-6 bg-white">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-semibold text-olive-dark">PQRS Internos</h1>
          </div>
          <div className="flex items-center space-x-4">
          ...
          <div className="space-y-8">
            <Card className="border-2 border-olive-dark/20 shadow-lg">
              <CardHeader className="text-center bg-gradient-to-r from-olive-dark to-olive-dark/90 text-white rounded-t-lg">
                ...
                <CardTitle className="text-2xl font-bold">Gestión de PQRS Internos</CardTitle>
              </CardHeader>
            </Card>
